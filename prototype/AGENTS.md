...
- Video belongs to the `Fotografie & Video` competence and is shown inside the same project grid; there is intentionally no separate video navigation item.
...
- `Leonding · Oberösterreich` must remain directly visible in the hero.
