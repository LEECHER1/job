...
export const projects = [
  ...
  },
  {
    ...
    eyebrow: "Vollständig selbst entwickelter Prototyp",
    text: "Diesen Prototypen zur digitalen Wasseranalyse habe ich zu 100 % selbst entwickelt – von der Produktidee über Gehäuse, Elektronik und Sensorik bis zur technischen Umsetzung.",
    disciplines: "Produktentwicklung · Elektronik · Sensorik · 3D · Prototyping",
    image: "workflow-smart-water-analyzer.jpg",
    alt: "Geschlossener und geöffneter Smart-Water-Analyzer-Prototyp mit sichtbarer Elektronik",
    tags: ["workflow-prototyping"],
    externalUrl: "https://theblackpixel.at/smart-water-analyzer/SWA-webseite.html",
    linkLabel: "Projektwebseite ansehen ↗",
  },
  {
    title: "SuperTranslator Pro",
    eyebrow: "InDesign-Plugin mit KI-Unterstützung",
    text: "Das Plugin für Adobe InDesign übersetzt Bedienungsanleitungen mit KI-Unterstützung und erhält Formatierung und Struktur möglichst weitgehend.",
    disciplines: "Adobe InDesign · Plugin · KI-Übersetzung · Automatisierung",
    image: "workflow-supertranslator-pro.jpg",
    alt: "Oberfläche von SuperTranslator Pro neben mehrsprachigen Ausschnitten einer Bedienungsanleitung",
    tags: ["workflow-prototyping"],
    externalUrl: "https://github.com/LEECHER1/SuperTranslatorPro",
    linkLabel: "GitHub-Projekt ansehen ↗",
  },
  {
    title: "PDF- & Etiketten-Automation",
    eyebrow: "Eigenentwickeltes Skript & Programm",
    text: "Das Werkzeug liest Artikelnummern aus mehrseitigen Etiketten-PDFs aus, exportiert die einzelnen Seiten mit den korrekten Dateinamen und führt Multipage-Etiketten zusammen – vorbereitet für Systemablage und Druckerei.",
    disciplines: "Python · PDF-Auslesen · Dateibenennung · Druckvorstufe",
    image: "workflow-pdf-label-automation.jpg",
    alt: "Oberfläche und Quellcode eines Programms zum Auslesen, Umbenennen und Zusammenführen von PDFs",
    tags: ["workflow-prototyping"],
  },
  {
    title: "InDesign- & Photoshop-Skripte",
    eyebrow: "Workflow-Automation",
    text: "Sammlung eigener Skripte für Bildguides, automatische Textrahmenhöhen in InDesign, die Stapelverarbeitung geöffneter Bilder sowie den automatischen Export von PDF-Dateien nach PNG oder JPG.",
    disciplines: "InDesign · Photoshop · Skripting · Stapelverarbeitung",
    image: "workflow-indesign-photoshop-scripts.jpg",
    alt: "Übersicht verschiedener InDesign- und Photoshop-Skripte mit Quellcode",
    tags: ["workflow-prototyping"],
  },
  {
